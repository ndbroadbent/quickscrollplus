...
Note: This application will only ever work on a jailbroken iPhone, and you must uninstall QuickScroll2 before you install this application.
...
Please not that compiling from source is not necessary. The instructions below are just included for anyone interested.

* Download the .deb package from the 'Downloads' section on this page.
* SSH the package to your iPhone.
* SSH into your iPhone.
* Make sure you have uninstalled QuickScroll2.
