...
This is a fork of QuickScroll2, including bug fixes and 'tilt' scrolling. It is only tested and working iOS 4.1. However, it is compiled with the 3.2 SDK, so it should work on most iPhones. If someone is able to confirm this, please let me know by raising an issue on the github page.

See here for the original QuickScroll2 project wiki: http://code.google.com/p/networkpx/wiki/Using_QuickScroll

Please be aware: This application will only ever work on a jailbroken iPhone.
...
* Fix up 'disabled apps' page:
** Work out how to get icons showing for some cases
