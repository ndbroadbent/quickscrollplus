...
h2. Current codebase is too unstable for use, so I have removed the package download. (will sometimes crash your SpringBoard if enabled, and possibly freeze your phone). Please wait for a stable release in the next few days.
...
The deb package will hopefully be hosted soon on a public repo.
