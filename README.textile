...
h2. an extension of QuickScroll2 by KennyTM~, developed by Nathan Broadbent (www.f-77.com)
...
This is a fork of QuickScroll2, including bug fixes and 'tilt' scrolling. Is tested and working iOS 4.1. However, it is compiled with the 3.2 SDK, so it should work on most devices. If someone is able to confirm this, please let me know by raising an issue on the github page.
